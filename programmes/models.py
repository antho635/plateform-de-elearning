...
class Commentaire(models.Model):
    ...
    # reponse = models.ForeignKey('Commentaire', null=True, blank=True, on_delete=models.CASCADE,
    ...
    def save(self, *args, **kwargs):
        self.nom_comm = slugify(f"commente par {str(self.auteur)}a {str(self.date_added)}")
